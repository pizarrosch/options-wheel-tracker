                                ...
                                {filtered.map(pos => {
                                    ...
                                    return (
                                        <tr key={pos.id} style={{ borderBottom:`1px solid ${D}22` }}
                                            ...
                                            <td style={{ padding:'9px 14px', fontFamily:'monospace', color:M }}>{(() => {
                                                if (!pos.openDate) return '—';
                                                const end = pos.closeDate ? new Date(pos.closeDate) : new Date();
                                                const days = Math.floor((end - new Date(pos.openDate)) / 86400000);
                                                return days + 'd';
                                            })()}</td>
